...
class BulkIngestionProcessorIntegrationTest extends PostgresIntegrationTestBase
{
    ...
    void shouldPublishAllNodesFromDb()
    {
        ...
        List<IngestEvent> categories = List.of(
                IngestEvent.builder().nodeId("94e0b276-6447-4dbc-b32a-1d37836a8066").properties(parseProperties("type=cm:category", "cm:name=Animal Species", "createdAt=2024-02-19T07:56:50.034Z", "aspectsNames=[cm:auditable]", "createdBy=admin", "modifiedBy=admin", "ALLOW_ACCESS=[GROUP_EVERYONE, guest]")).timestamp(TIMESTAMP).build(),
                IngestEvent.builder().nodeId("11dedf84-4ebb-431e-adbf-7e92b2792674").properties(parseProperties("type=cm:category", "cm:name=Mammal", "createdAt=2024-02-19T07:57:10.868Z", "aspectsNames=[cm:auditable]", "createdBy=admin", "modifiedBy=admin", "ALLOW_ACCESS=[GROUP_EVERYONE, guest]")).timestamp(TIMESTAMP).build(),
                IngestEvent.builder().nodeId("fa6b38cd-442a-4f77-9d3e-dc212a6b809e").properties(parseProperties("type=cm:category", "cm:name=Fish", "createdAt=2024-02-19T07:57:44.072Z", "aspectsNames=[cm:auditable]", "createdBy=admin", "modifiedBy=admin", "ALLOW_ACCESS=[GROUP_EVERYONE, guest]")).timestamp(TIMESTAMP).build());

        IngestEvent folder = IngestEvent.builder().nodeId("dad275aa-affc-487d-a7ed-92cf8e6ce351").properties(parseProperties("type=cm:folder", "cm:name=Animals", "cm:title=Animals overview", "createdAt=2024-02-19T07:55:23.195Z", "aspectsNames=[cm:titled, cm:auditable]", "createdBy=admin", "cm:description=This folder contains overview of the animals in our zoo", "modifiedBy=admin", "ALLOW_ACCESS=[GROUP_EVERYONE]")).timestamp(TIMESTAMP).build();
