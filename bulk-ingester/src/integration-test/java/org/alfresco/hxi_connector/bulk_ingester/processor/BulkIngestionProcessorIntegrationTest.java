...
class BulkIngestionProcessorIntegrationTest extends PostgresIntegrationTestBase
{
    ...
    void shouldPublishAllNodesFromDb()
    {
        ...
        List<IngestEvent> categories = List.of(
                IngestEvent.builder().nodeId("94e0b276-6447-4dbc-b32a-1d37836a8066").properties(parseProperties("type=cm:category", "cm:name=Animal Species", "createdAt=1708329410", "aspectsNames=[cm:auditable]", "createdBy=admin", "modifiedBy=admin", "ALLOW_ACCESS=[GROUP_EVERYONE, guest]")).timestamp(TIMESTAMP).build(),
                IngestEvent.builder().nodeId("11dedf84-4ebb-431e-adbf-7e92b2792674").properties(parseProperties("type=cm:category", "cm:name=Mammal", "createdAt=1708329430", "aspectsNames=[cm:auditable]", "createdBy=admin", "modifiedBy=admin", "ALLOW_ACCESS=[GROUP_EVERYONE, guest]")).timestamp(TIMESTAMP).build(),
                IngestEvent.builder().nodeId("fa6b38cd-442a-4f77-9d3e-dc212a6b809e").properties(parseProperties("type=cm:category", "cm:name=Fish", "createdAt=1708329464", "aspectsNames=[cm:auditable]", "createdBy=admin", "modifiedBy=admin", "ALLOW_ACCESS=[GROUP_EVERYONE, guest]")).timestamp(TIMESTAMP).build());
