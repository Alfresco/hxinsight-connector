...
class BulkIngestionProcessorIntegrationTest extends PostgresIntegrationTestBase
{
    ...
    void shouldPublishAllNodesFromDb()
    {
        ...
        IngestEvent textFile = IngestEvent.builder().nodeId("44545a62-0f64-4d3e-838a-9f8ba23df0c7")
                ...
                .properties(parsePropertiesWithAncestors(
                        ...
                        "cm:categories=25805c3b-dc41-4a3d-9b03-a44ac7963c70", "createdBy=admin",
                        "cm:lastThumbnailModification=[doclib:1708329633941, pdf:1708329629285]",
                        "cm:description=List of animals in our zoo", "modifiedBy=admin", "ALLOW_ACCESS=[GROUP_EVERYONE]"))
                .timestamp(TIMESTAMP).build();

        List<IngestEvent> pdfFiles = List.of(
                IngestEvent.builder().nodeId("02acf462-533d-4e1b-9825-05fa934140da")
                        ...
                        .properties(parsePropertiesWithAncestors(
                                ...
                                "cm:categories=fa6b38cd-442a-4f77-9d3e-dc212a6b809e", "cm:lastThumbnailModification=doclib:1708330172467",
                                "cm:description=", "createdAt=2024-02-19T08:09:32.182Z", "modifiedAt=2024-02-19T09:31:54.728Z",
                                "cm:initialVersion=true", "createdBy=admin", "modifiedBy=admin", "ALLOW_ACCESS=[GROUP_EVERYONE]"))
                        .timestamp(TIMESTAMP).build(),
                IngestEvent.builder().nodeId("f9d6264e-426b-41cd-9f4b-b660dc582311")
                        ...
                        .properties(parsePropertiesWithAncestors(
                                ...
                                "aspectsNames=[cm:generalclassifiable, cm:versionable, cm:author, cm:thumbnailModification, cm:titled, cm:taggable, rn:renditioned, cm:auditable]",
                                "cm:categories=11dedf84-4ebb-431e-adbf-7e92b2792674", "type=cm:content",
                                "cm:lastThumbnailModification=doclib:1708330181376", "cm:description=", "createdAt=2024-02-19T08:09:40.810Z",
                                "modifiedAt=2024-02-19T09:32:05.282Z", "cm:initialVersion=true", "createdBy=admin", "modifiedBy=admin",
                                "ALLOW_ACCESS=[GROUP_EVERYONE]"))
                        .timestamp(TIMESTAMP).build(),
                IngestEvent.builder().nodeId("71b5b65b-d92a-4944-9403-48b7ebf8664c")
                        ...
                        .properties(parsePropertiesWithAncestors(
                                ...
                                "aspectsNames=[cm:generalclassifiable, cm:versionable, cm:author, cm:thumbnailModification, cm:titled, cm:taggable, rn:renditioned, cm:auditable]",
                                "cm:categories=11dedf84-4ebb-431e-adbf-7e92b2792674", "type=cm:content",
                                "cm:lastThumbnailModification=doclib:1708330181340", "cm:description=", "createdAt=2024-02-19T08:09:40.919Z",
                                "modifiedAt=2024-02-19T09:32:15.922Z", "cm:initialVersion=true", "createdBy=admin", "modifiedBy=admin",
                                "ALLOW_ACCESS=[GROUP_EVERYONE]"))
                        .timestamp(TIMESTAMP).build());
