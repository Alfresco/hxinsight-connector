 ...
 * #L%
 */
package org.alfresco.hxi_connector.nucleus_sync.config;
...
public class AuthConfig
{
    ...
    @Bean
    public AccessTokenProvider accessTokenProvider(AuthenticationClient authenticationClient)
    {
        return new DefaultAccessTokenProvider(authenticationClient);
    }

    @Bean
    public AuthService authService(
            AuthProperties authProperties, AccessTokenProvider accessTokenProvider)
    {
        return new AuthService(authProperties, accessTokenProvider);
    }
}
