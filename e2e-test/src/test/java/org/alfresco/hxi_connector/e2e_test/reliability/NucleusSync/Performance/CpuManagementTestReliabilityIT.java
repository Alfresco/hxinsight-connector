...
/**
 * Measures JVM and system CPU utilization during the 1M-user mapping sync.
 * Detects CPU bottlenecks — excessive serialization, tight spin loops, or
 * unbounded parallelism that saturates all available cores.
 *
 * <p>Asserts that:
 * <ul>
