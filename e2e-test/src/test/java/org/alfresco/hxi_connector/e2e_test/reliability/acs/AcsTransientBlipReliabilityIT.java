...
/**
 * Brief ACS REST blip shorter than the content-download retry budget must recover via {@code @Retryable} or JMS redelivery: the event reaches HX Insight, DLQ stays empty.
 */
@Slf4j
...
public class AcsTransientBlipReliabilityIT extends BaseReliabilityIT
{
    ...
    /** Long enough to fail the first content-download attempt, short enough that retries recover before DLQ. */
