    ...
    private void waitUntilServiceIsReadyForSync()
    {
        RetryUtils.retryWithBackoff(() -> {
            try
            {
                ...
                // Verify nucleus-sync can reach Alfresco from within its container (warmup check)
                ...
                {
                    throw new AssertionError("sync trigger returning 503 (Alfresco unavailable from nucleus-sync): " + syncResp.body());
                }
